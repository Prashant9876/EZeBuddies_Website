...
const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    "sinchaiPlanner.overlapDescription": "{{first}} overlaps with {{second}} on {{days}}. Please adjust time or days.",
  },
  hi: {
    ...
    "sinchaiPlanner.overlapDescription": "{{first}} और {{second}} {{days}} पर आपस में टकरा रहे हैं। कृपया समय या दिन बदलें।",
  },
};
