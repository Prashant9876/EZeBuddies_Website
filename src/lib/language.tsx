...
const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    "dashboard.estopActiveDescription": "This section is stopped. Disable E-Stop to operate controls.",
  ...
  hi: {
    ...
    "dashboard.estopActiveDescription": "यह सेक्शन रोका गया है। कंट्रोल चलाने से पहले ई-स्टॉप हटाएं।",
